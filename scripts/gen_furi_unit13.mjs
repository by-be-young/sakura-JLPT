// 为听解 unit13 数据生成振假名（ruby）与读音（kana）
// 用法：node scripts/gen_furi_unit13.mjs
import fs from 'fs'
...
const DIR = 'D:/日语自学网站/src/data/listening/unit13'
...
fs.writeFileSync(DIR + '/words.js',
  '// 听解 unit13 Part2 攻略編 Unit5 統合理解 · 词汇板块（本单元为攻略编，无独立词汇表）\n' +
  '// 来源：绿宝书《新日本语能力考试N2听解（详解+练习）》Part2 攻略編 Unit5 統合理解\n' +
...
fs.writeFileSync(DIR + '/questions.js',
  '// 听解 unit13 Part2 攻略編 Unit5 統合理解 · 题目板块（問題530-536）\n' +
  '// 来源：绿宝书《新日本语能力考试N2听解（详解+练习）》Part2 攻略編 Unit5 統合理解 书页237-259\n' +
...
fs.writeFileSync(DIR + '/knowledge.js',
  '// 听解 unit13 Part2 攻略編 Unit5 統合理解 · 补充知识（試験対策）\n' +
  '// 来源：绿宝书《新日本语能力考试N2听解（详解+练习）》Part2 攻略編 Unit5 統合理解 书页98-103\n' +
